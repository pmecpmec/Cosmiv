...
class ContentRenewalService:
    ...
    def generate_content(
        self, content_type: str, context: Optional[Dict[str, Any]] = None, style: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def renew_content(self, content_id: str, content_type: str, force: bool = False) -> Dict[str, Any]:
        """
    ...
    def publish_version(self, content_id: str, version: int) -> bool:
        ...
        try:
            with get_session() as session:
                ...
                session.exec(
                    select(ContentVersion).where(
                        ContentVersion.content_id == content_id, ContentVersion.status == "published"
                    )
                ).all()
