...
class YouTubePoster:
    ...
    def post_video(
        ...
        try:
            ...
            return YouTubePoster.post_video(
...
class InstagramPoster:
    ...
    def post_video(
        ...
        if not settings.INSTAGRAM_API_ENABLED:
            # Mock mode
            logger.info(
                "Instagram posting (mock mode)", extra={"platform": "instagram"}
            )
            return {
                "success": True,
                "platform": "instagram",
...
def post_to_social_media(
    platform: str, video_path: str, caption: str, access_token: str, **kwargs
) -> Dict[str, Any]:
    """
    ...
    """
    if platform == "tiktok":
        return TikTokPoster.post_video(
            video_path, caption, access_token, kwargs.get("user_id")
        )
    elif platform == "youtube":
        return YouTubePoster.post_video(
            video_path, caption, access_token, kwargs.get("title")
        )
    elif platform == "instagram":
        return InstagramPoster.post_video(
            video_path, caption, access_token, kwargs.get("instagram_account_id")
        )
    else:
