...
async def ai_chat(
    ...
    try:
        ...
        if online_admins:
            ...
            system_prompt = (
                "You are Cosmiv's AI assistant. A human admin is currently online "
                "and may respond if needed.\nAnswer questions about:\n"
                ...
                "Be friendly, concise, and helpful. Mention that admins are "
                "available if they need more help."
            )
        else:
            system_prompt = (
                "You are Cosmiv's AI assistant - a helpful, professional support "
                "agent for our AI Gaming Montage Platform.\nAnswer questions about:\n"
                "- How to use the platform\n"
                "- Video editing features\n"
                "- Uploading clips\n"
                "- Subscription plans\n"
                ...
                "direct users to our support channels."
            )
