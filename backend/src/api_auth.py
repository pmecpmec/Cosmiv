...
# Import get_session directly from db - tests will patch db.get_session
...
class UserRegisterRequest(BaseModel):
    """Registration request model - accepts JSON"""
...
async def register(user_data: UserRegisterRequest):
    ...
    username = (
        user_data.username or email.split("@")[0]
    )  # Use email prefix if no username
...
class UserLoginRequest(BaseModel):
    """Login request model - accepts JSON"""
