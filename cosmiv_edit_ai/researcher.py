...
class Researcher:
    ...
    def __init__(self, config_path: str = "core/config.json"):
        ...
        self.openai_api_key = os.getenv("OPENAI_API_KEY") or self.config.get(
            "openai_api_key", ""
        )
        ...
        if self.youtube_api_key:
            ...
            self.youtube = None
            print(
                "Warning: YouTube API key not set. Research functionality will be limited."
            )
...
Return only valid JSON, no markdown formatting."""
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert video editing analyst. Extract precise, actionable rules from tutorials.",
                    },
