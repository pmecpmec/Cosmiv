...
Examples:
  ...
  python main.py --trends
    ...
    parser.add_argument("--config", type=str, default="core/config.json",
    ...
    parser.add_argument("--once", action="store_true",
                        help="Run training cycle once (don't loop)")
    parser.add_argument("--research", action="store_true",
                        help="Research new tutorials only")
    parser.add_argument("--trends", action="store_true",
                        help="Update trends only")
    parser.add_argument("--edit", type=str, metavar="VIDEO",
                        help="Edit a video")
    parser.add_argument("--evaluate", type=str, metavar="VIDEO",
                        help="Evaluate a video")
    parser.add_argument("--update", action="store_true",
                        help="Run self-update only")
    parser.add_argument("--test-video", type=str,
                        help="Test video path for training cycle")
    
    args = parser.parse_args()
    
    # If no action specified, show help
    if not any([args.train, args.research, args.trends, args.edit, args.evaluate, args.update]):
        parser.print_help()
        return
