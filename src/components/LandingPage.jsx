      ...
      <section className="pt-32 pb-hero px-4 min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            <AnimatedHeroText
              text="🌌 C O S M I V"
              className="text-6xl md:text-8xl lg:text-9xl cursor-pointer select-none"
              delay={0.2}
              stagger={0.03}
            />
            <motion.div
              ...
              title="Try triple-clicking me..."
            >
              <motion.div
                className="text-xs md:text-sm text-cosmic-neon-cyan/50 font-bold tracking-widest"
                animate={{
                  opacity: [0.3, 0.7, 0.3],
                }}
                transition={{
          ...
          >
            <motion.p 
              className="text-3xl md:text-5xl lg:text-6xl text-white/95 mb-6 font-black tracking-tight"
              animate={{
                textShadow: [
          ...
          >
            <p className="text-lg md:text-2xl text-white/80 mb-12 max-w-3xl mx-auto font-bold leading-relaxed">
          ...
          >
            <motion.button
              ...
              whileHover={{ 
                scale: 1.08, 
                y: -4,
                boxShadow: "0 0 40px rgba(139, 92, 246, 0.8), 0 0 60px rgba(0, 255, 255, 0.6), 0 10px 30px rgba(0, 0, 0, 0.5)"
              }}
              whileTap={{ scale: 0.95 }}
              className="px-16 py-6 bg-gradient-to-r from-cosmic-violet to-cosmic-deep-blue hover:from-cosmic-purple hover:to-cosmic-violet text-white font-black border-2 border-cosmic-neon-cyan/50 text-xl tracking-wide transition-all neon-glow hover:neon-glow-cyan chromatic-aberration rounded-lg relative overflow-hidden group"
            >
              {/* Button glow effect */}
              <motion.div
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-16 py-6 bg-white/5 hover:bg-white/10 text-white font-bold border-2 border-white/20 hover:border-cosmic-neon-cyan/70 text-xl tracking-wide transition-all rounded-lg backdrop-blur-sm relative overflow-hidden group"
            >
